    ...
    return (
        <div className="fixed bottom-6 right-6 z-50">
            ...
            <div className="absolute inset-0 animate-pulse">
                <div className="h-full w-full rounded-full bg-green-500 opacity-30"></div>
            </div>
            ...
            <a
                ...
                className="relative flex items-center justify-center bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-2xl hover:shadow-green-500/50 transition-all duration-300 hover:scale-110 group"
                aria-label="Chat on WhatsApp"
            >
                {/* WhatsApp Logo SVG */}
                <svg className="h-7 w-7 animate-bounce" viewBox="0 0 24 24" fill="currentColor">
